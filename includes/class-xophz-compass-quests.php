...
class Xophz_Compass_Quests {
	...
	public function __construct() {
		if ( defined( 'XOPHZ_COMPASS_QUESTS_VERSION' ) ) {
			$this->version = XOPHZ_COMPASS_QUESTS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'xophz-compass-quests';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-xophz-compass-quests-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-xophz-compass-quests-i18n.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new Xophz_Compass_Quests_i18n();
